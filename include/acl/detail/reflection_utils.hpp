...
template <typename T>
requires(!detail::IsBasicString<T> && !detail::CastableToStringView<T> && !detail::TransformToString<T> &&
...
requires(detail::HasValueType<C> && detail::HasEmplace<C, container_value_t<C>> &&
         !detail::HasEmplaceBack<C, container_value_t<C>>) static inline void emplace(C& c, Args&&... args)
{
...
template <typename C, typename... Args>
requires(detail::HasValueType<C> && !detail::HasEmplace<C, container_value_t<C>> &&
         !detail::HasEmplaceBack<C, container_value_t<C>> && detail::HasPushBack<C, container_value_t<C>>)
