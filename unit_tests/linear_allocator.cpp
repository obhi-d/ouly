...
TEST_CASE("Validate linear_stack_allocator with alignment", "[linear_stack_allocator]")
{
  ...
  std::uint8_t* first = nullptr;
  {
    ...
    [[maybe_unused]] auto a3 = acl::allocate<std::uint8_t>(allocator, 16, 0);
    auto                  r2 = allocator.get_rewind_point();
    auto                  a4 = acl::allocate<std::uint8_t>(allocator, 32, 0);
    [[maybe_unused]] auto a6 = acl::allocate<std::uint8_t>(allocator, 32, 0);
    allocator.rewind(r2);
    ...
    [[maybe_unused]] auto a8  = acl::allocate<std::uint8_t>(allocator, 128, 0);
    [[maybe_unused]] auto a9  = acl::allocate<std::uint8_t>(allocator, 32, 0);
    [[maybe_unused]] auto a10 = acl::allocate<std::uint8_t>(allocator, 64, 0);
    allocator.rewind(r3);
