...
inline euler_angles_t<scalar_t> canonize(euler_angles_t<scalar_t> const& m)
...
template <typename scalar_t>
inline euler_angles_t<scalar_t> make_euler_angles(quat_t<scalar_t> const& src)
{
  euler_angles_t<scalar_t>  r;
  float src_x = x(src);
  float src_y = y(src);
...
template <typename scalar_t>
inline euler_angles_t<scalar_t> make_euler_angles_from_quat_conjugate(quat_t<scalar_t> const& src)
{
  euler_angles_t<scalar_t>  r;
  float src_x = x(src);
  float src_y = y(src);
...
template <typename scalar_t>
inline euler_angles_t<scalar_t> make_euler_angles(mat3_t<scalar_t> const& src)
{
  euler_angles_t<scalar_t> r;
...
template <typename scalar_t>
inline euler_angles_t<scalar_t> make_euler_angles(mat4_t<scalar_t> const& m)
{
